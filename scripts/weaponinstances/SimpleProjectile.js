...
SimpleProjectileClass = WeaponInstanceClass.extend({
  ...
  update : function() {
    ...
    this.physBody.SetLinearVelocity(new Vec2(this.dir.x * this._speed + adjust.x, this.dir.y * this._speed + adjust.y));
  ...
  onTouch : function(otherBody, point, impulse) {
    ...
    return true;
    //return false if we don't validate the collision
  },
  //--------------------------------------
});
