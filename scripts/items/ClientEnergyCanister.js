...
ClientEnergyCanisterClass = EnergyCanisterClass.extend({
  _spriteAnim : null,
  init : function(x, y, settings) {
    ...
    for (var i = 0; i < 10; i++)
      this._spriteAnim.pushFrame("energy_canister_blue_000" + i + ".png");
    for (var i = 10; i < 16; i++)
      this._spriteAnim.pushFrame("energy_canister_blue_00" + i + ".png");
...
Factory.nameClassMap['EnergyCanister'] = ClientEnergyCanisterClass;
