...
function al_isImgFilename(fname) {
  return fname.indexOf('.jpg') != -1 || fname.indexOf('.png') != -1 || fname.indexOf('.gif') != -1 || fname.indexOf('.wp') != -1;
};

function al_isSoundFilename(fname) {
  return fname.indexOf('.ogg') != -1 || fname.indexOf('.ogg') != -1 || fname.indexOf('.ogg') != -1 != -1;
};
